...
| Método                | Núcleos CPU | Tiempo Total de Procesamiento (s) | Tiempo Promedio por Chunk (s) | Tasa de Procesamiento (resultados/s) |
|-----------------------|-------------|-----------------------------------|-------------------------------|--------------------------------------|
| Fortran (Secuencial)  | 1           | 3179.58                           | 17.96                         | 554.97                               |
| C++ Búsqueda Lineal   | 8           | 8572.34                           | 48.39                         | 132.48                               |
| C++ Unordered Map     | 8           | 362.71                            | 1.99                          | 3109.86                              |

- **Mejora C++ (Lineal vs. Unordered Map)**: ~23x más rápido en tiempo total, con una tasa de procesamiento aumentada en ~23x.
- **Comparación con Fortran**: El código Fortran secuencial procesa a una tasa de ~555 resultados/segundo, siendo ~4x más rápido que la versión C++ con búsqueda lineal, pero ~5.6x más lento que la versión C++ optimizada con paralelismo y estructuras de datos eficientes. Esto resalta la importancia de multithreading y estructuras de datos adecuadas en C++ para superar implementaciones secuenciales en problemas de alto rendimiento, especialmente en datasets grandes.
